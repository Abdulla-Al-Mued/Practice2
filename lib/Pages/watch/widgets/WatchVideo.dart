...
import '../../news_feed/widgets/post_content.dart';
import '../screens/WatchScreen.dart';
import '../screens/watch_others_screen.dart';
              ...
              children: [
                Row(
                  children: [
                    CircleAvatar(
                      radius: 20,
                      backgroundImage: AssetImage(widget.post.user.avater),
                    ),
                    Padding(
